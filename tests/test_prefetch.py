...
def test_prefetch_tra_cut_inter(test_data_dir, test_ref_path):
    ...
    assert 1000 in tra_map['deletions']['chr2']
    assert tra_map['deletions']['chr2'][1000] == (1000, 'CUT1')
...
def test_prefetch_tra_cut_intra(test_data_dir, test_ref_path):
    ...
    assert 3000 in tra_map['deletions']['chr1']
    assert tra_map['deletions']['chr1'][3000] == (1000, 'CUT2')
